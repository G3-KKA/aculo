...
func (_m *MockController) Tx() (ControllerAPI, unifaces.TxClose, error) {
	ret := _m.Called()
	...
	var r0 ControllerAPI
	var r1 unifaces.TxClose
	var r2 error
	if rf, ok := ret.Get(0).(func() (ControllerAPI, unifaces.TxClose, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() ControllerAPI); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ControllerAPI)
		}
	}
